...
export const metadata: Metadata = {
  ...
  description:
    'Explorá nuestro catálogo de ramos artesanales, arreglos para nacimientos, aniversarios, cumpleaños y condolencias. Consultá disponibilidad por WhatsApp.',
}
        ...
        <section className="border-b border-border/60 bg-secondary/30">
          <div className="mx-auto max-w-7xl px-4 py-12 md:px-8 md:py-16">
            ...
            <p className="mt-4 max-w-2xl text-pretty text-muted-foreground">
              Filtrá por categoría, buscá por nombre y consultá disponibilidad
              directamente por WhatsApp. Trabajamos con flores frescas seleccionadas
              según la temporada.
            </p>
          </div>
        </section>
